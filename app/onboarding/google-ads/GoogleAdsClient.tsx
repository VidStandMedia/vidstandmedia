        ...
        <div className="mt-14 rounded-2xl border border-gray-300 bg-white p-8 shadow-sm">
          ...
          {hasAccount === false && (
            ...
            <div className="mt-10 rounded-xl bg-gray-50 p-6">
              ...
              <p className="mt-3 text-gray-700">
                You will create your own Google Ads account,
                add your payment method directly with Google,
                and return here with your Customer ID.
              </p>
              ...
              <p className="mt-4 text-sm leading-6 text-gray-600">
                Start creating your Google Ads account by
                following the steps on Google's official
                website. Once your account has been created,
                return here and continue with your campaign setup.
              </p>
